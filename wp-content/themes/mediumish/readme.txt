...
- Added Sendy integration (search from your dashboard the plugin "Sendy – API Integration", activate it, go to Settings/Sendy API and enter the details; then simply paste the shortcode [sendy] in Customize/Articles/Bottom Alert Bar. The subscribe form will appear integrated with theme's design.)
