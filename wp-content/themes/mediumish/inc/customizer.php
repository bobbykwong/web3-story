...
Mediumish_Kirki::add_field( 'mediumish_theme', array(
    ...
    'output' => array(
        array(
			'element'  => '.article-post a:not(.wp-block-button__link), .post .btn.follow, .post .post-top-meta .author-description a, article.page a:not(.wp-block-button__link), .alertbar a',
			'property' => 'color',
		),
        array(
...
Mediumish_Kirki::add_field( 'mediumish_theme', array(
	...
	'output' => array(
		array(
      	'element' => array( '.entry-content.page-content'),
		),
	),
) );
...
if ( class_exists( 'Kirki_Helper' ) ) {
	$defaultscat = array_keys(Kirki_Helper::get_terms( 'category' ));
	$defaultcat = $defaultscat[0];
	...
	Mediumish_Kirki::add_field( 'mediumish_theme', array(
		...
		'default'     => array(
			array(          
				'categoryfield'  => $defaultcat,
				'categorystyle'  => 'style-1',
			),        
		),
		'placeholder' => esc_attr__( 'Select an option', 'mediumish' ), 
		'fields'     => array(
			'categoryfield' => array(
				'type'        => 'select',
...
Mediumish_Kirki::add_field( 'mediumish_theme', array(
	'type'        => 'checkbox',
	'settings'    => 'disable_share_pest',
	'label'       => esc_html__( 'Disable Pest Share in Articles', 'mediumish' ),
	'section'     => 'sectionarticles',
	'priority'    => 10,
	'default'     => '0',
) );
...
Mediumish_Kirki::add_field( 'mediumish_theme', array(
	...
	'label'       => esc_attr__( 'Change "All Stories" text', 'mediumish' ),
	'section'     => 'section_misc',
	'priority'    => 10,
	'default'     => 'All Stories',
) );