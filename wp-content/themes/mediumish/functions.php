...
function mediumish_enqueue_scripts() {        
    wp_enqueue_script( 'bootstrap4tether', get_template_directory_uri() . '/assets/js/tether.min.js', array('jquery'), null, true );
    ...
    wp_enqueue_style( 'mediumish-style', get_stylesheet_uri(), [], THEME_VERSION, 'all');
...
function mediumish_postbox() {
    ...
    <a class="postbox_default_thumbnail" href="<?php the_permalink(); ?>" alt="<?php the_title(); ?>">
...
function mediumish_post_card_highlight_first () { 
    ...
    <div class="card post <?php if ( $featured_img_url) { echo 'highlighted'; } else { echo 'h-100'; }?>">
            ...
            <span class="card-text d-block"><?php echo excerpt(24); ?></span>
            <div class="metafooter mt-auto"> 
...
$featured_img_url = get_the_post_thumbnail_url(get_the_ID(),'full');
?>
<div class="card post_card_tall h-100" id="post-<?php echo the_ID(); ?>">
    <div class="row h-100">
        <?php if ($featured_img_url) { ?>
        <div class="col-md-5 wrapthumbnail">
            <a class="d-block h-100" href="<?php echo get_permalink(); ?>">
...
function hide_featured_image_html( $post) {
	...
	<p>
		...
		<label for="hide_featured_image_hide_featured_image_on_post"><?php _e( 'Hide featured image on post', 'mediumish' ); ?></label>	</p><?php
}
    ...
    function mediumish_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
             ...
             array(
                'name'     => esc_html__('Frontend Post Submission Manager Lite', 'mediumish'),
